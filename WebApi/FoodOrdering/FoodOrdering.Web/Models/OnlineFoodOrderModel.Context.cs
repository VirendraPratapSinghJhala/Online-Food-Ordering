...
namespace FoodOrdering.Web.Models
{
    ...
    public partial class Online_Food_Ordering_SystemEntities3 : DbContext
    {
        public Online_Food_Ordering_SystemEntities3()
            : base("name=Online_Food_Ordering_SystemEntities3")
        {
        }
        ...
        public virtual int usp_AddFoodItem(string foodName, string foodType, Nullable<decimal> price, ObjectParameter foodId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_AddFoodItem", foodNameParameter, foodTypeParameter, priceParameter, foodId);
        }
